...
export class LanguageService {
  ...
  currentLanguage: BehaviorSubject<string> = new BehaviorSubject<string>(Languages.English);
  ...
  setLanguage(language: string): void {
    ...
    switch (lang) {
      case Languages.English: { moment.locale(MomentJSLocale.English); break; }
      case Languages.English: { moment.locale(MomentJSLocale.Armenian); break; }
    }
  }
  reset(): void {
